  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      if (window.matchMedia("(pointer:fine)").matches) {
        ...
        const followX = gsap.quickTo(cursorFollower.current, "x", {
          duration: 0.45,
          ease: "power3"
        });

        const followY = gsap.quickTo(cursorFollower.current, "y", {
          duration: 0.45,
          ease: "power3"
        });
        ...
        const interactive = document.querySelectorAll(
          "a, button, .skill-card, .timeline-card, .contact-card"
        );
      ...
      <main>
        ...
        <section id="sobre-mi" className="section about">
          ...
          <div className="about-content">
            ...
            <p className="about-lead">
              <span>
                Soy David, técnico de sistemas y actualmente
              </span>
              <span>
                estudiante de Desarrollo de Aplicaciones
              </span>
              <span>
                Multiplataforma. Me apasiona la tecnología
              </span>
              <span>
                y todo lo que puedo construir con ella.
              </span>
            </p>

            <p className="about-detail reveal">
              Me considero una persona motivada, responsable y con ganas de
              seguir creciendo. Me gusta aprender nuevas tecnologías,
              enfrentarme a retos y convertir cada experiencia en una
          ...
          <div className="timeline">
            ...
            <article className="timeline-item">
              ...
              <div className="timeline-card">
                <div className="institute-img-wrap">
                  <img
                    src="/miguelSanchezLopez.png"
                    alt="IES Miguel Sánchez López"
                ...
                <div>
                  <a
                    href="https://www.iesmiguelsanchezlopez.es/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    VISITAR CENTRO ↗
            ...
            <article className="timeline-item timeline-right">
              ...
              <div className="timeline-card">
                <div className="institute-img-wrap">
                  <img
                    src="/IES-Fernando-III_logo.jpg"
                    alt="IES Fernando III"
                    className="institute-img"
                  />
                </div>
        ...
        <section id="tecnologias" className="section skills">
          ...
          <div className="skills-head">
            ...
            <p className="reveal">
              Tecnologías y conocimientos que forman parte de mi aprendizaje y
              desarrollo.
            </p>
          </div>
          ...
          <div className="skills-slider-wrap">
            <div className="skills-grid">
              <article className="skill-card">
                ...
                <h3>HTML5</h3>
                <p>
                  Estructura semántica, accesible y bien organizada para
                  aplicaciones web.
                </p>
              ...
              <article className="skill-card">
                ...
                <h3>CSS3</h3>
                <p>
                  Diseño responsive, animaciones y maquetación web moderna.
                </p>
                <span className="card-arrow">↗</span>
              </article>
              ...
              <article className="skill-card">
                ...
                <h3>JavaScript</h3>
                <p>
                  Lógica de programación e interactividad dinámica en el
                  cliente.
                </p>
                <span className="card-arrow">↗</span>
              </article>
              ...
              <article className="skill-card">
                ...
                <h3>Java</h3>
                <p>
                  Programación orientada a objetos y desarrollo de
                  aplicaciones.
                </p>
                <span className="card-arrow">↗</span>
              </article>
              ...
              <article className="skill-card">
                ...
                <h3>SQL</h3>
                <p>
                  Consultas, diseño y gestión eficiente de bases de datos
                  relacionales.
                </p>
                <span className="card-arrow">↗</span>
              </article>
              ...
              <article className="skill-card">
                ...
                <p>
                  Configuración, mantenimiento de equipos y arquitectura de
                  redes.
                </p>
                <span className="card-arrow">↗</span>
              </article>
          ...
          <div className="practice-layout">
            <div>
              ...
              <p className="practice-intro reveal">
                ...
                <strong>IES Santa Teresa</strong>, poniendo en práctica los
              ...
              <div className="practice-center-card reveal">
                <img
                  src="/santaTeresa.jpg"
                  alt="IES Santa Teresa"
                  className="practice-center-img"
                />
        ...
        <section className="statement">
          ...
          <p className="statement-copy reveal">
            ...
            conocimientos y convertir cada nuevo reto en una oportunidad para
            aprender.
          </p>
        </section>
        ...
        <section id="contacto" className="contact">
          ...
          <div className="contact-inner">
            ...
            <p className="contact-copy">
              Estoy abierto a nuevas oportunidades, proyectos y retos en el
              mundo tecnológico.
            </p>
            ...
            <div className="contact-cards">
              <a
                ...
                href="mailto:davidcas3008@gmail.com"
              >
              ...
              <a
                className="contact-card"
                href="https://www.linkedin.com/in/david-castillo-bb9271436/"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a
                className="contact-card"
                href="https://www.instagram.com/_daaviid.1010/"
                target="_blank"
                rel="noreferrer"
              >
